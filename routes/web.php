...
Route::prefix('admin')->name('admin.')->middleware('isAdmin')->group(function () {
    ...
    Route::get('/category/institution/', [App\Http\Controllers\Admin\CategoryController::class, 'index'])->name('institution.category');
    Route::get('/category/institution/create', [App\Http\Controllers\Admin\CategoryController::class, 'create'])->name('institution.category.create');
 ...
 Route::get('/institution/delete/{id}', [InstitutionController::class, 'delete'])->name('institution.delete');
 Route::get('/institution/trash', [InstitutionController::class, 'trashed'])->name('institution.trash');
 Route::get('/institution/recover/{id}', [InstitutionController::class, 'recover'])->name('institution.recover');
 Route::post('/updatestatus', [InstitutionController::class, 'updateorder'])->name('institution.updateswitch');
 ...
 Route::resource('vocation', VocationController::class);
 Route::get('/vocation/delete/{id}',[App\Http\Controllers\Admin\VocationController::class,'delete'])->name('vocation.delete');
 Route::get('/vocation/trash', [App\Http\Controllers\Admin\VocationController::class, 'show'])->name('vocation.trash');
 Route::get('/vocation/sendmail/{id}', [App\Http\Controllers\Admin\VocationController::class, 'sendmail'])->name('vocation.sendmail');
 Route::get('/vocation/recover/{id}', [App\Http\Controllers\Admin\VocationController::class, 'recover'])->name('vocation.recover');
});
