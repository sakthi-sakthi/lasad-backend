    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">{{ __('Add Institutions') }}</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('Add Institutions') }}</li>
                        </ol>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
        ...
        <div class="content">
            <div class="container-fluid"> 
                <form action="{{ route('admin.institution.store') }}" method="post" id="form" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                      <input type="text" class="form-control form-control-sm" id="year" name="year" value="{{ old('year') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="card">
