                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('admin.ourteams.index') }}">{{ __('Members') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('Edit Members') }}</li>
                        </ol>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="title">{{ __('Role (or) Position')  }}</label>
                                        <input type="text"
                                    ...
                                    <div class="form-group">
                                        <label for="title">{{ __('Place of work') }}</label>
                                        <input type="text"
                                            class="form-control form-control-sm @error('place') is-invalid @enderror"
                                            id="place" name="place" value="{{ old('place') ?? $ourteam->place }}">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" name="year" id="year" value="{{ old('year') ?? $ourteam->year }}">
                                    </div>
                                </div>
                            </div>
                            <div class="card">
