    ...
    <!-- Default to the left -->
    <center>
    <strong>{{ __('main.Copyright') }} &copy; {{ date('Y') }} <a href="https://lasalleindia.org/" target="_blank" rel="noopener noreferrer">Welcome to De La Salle Brothers</a>.</strong> {{ __('main.All rights reserved.') }}
</center>
    </footer>
</div>
<!-- Include jQuery -->
