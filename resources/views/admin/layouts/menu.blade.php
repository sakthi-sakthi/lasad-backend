...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #172440;">
    ...
    <img src="{{asset('admin')}}/img/delasalle.png" alt="HasPanel Logo" class="brand-image img-circle elevation-3" >
     <strong class="brand-text font-weight-light" style=""> <span style="font-weight: 700;">De La Salle Brothers</span></strong>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview @if(Request::segment(2)=="institution" || Request::segment(3)== "institution") menu-open @endif">
          <a href="{{ route('admin.institution.index') }}" class="nav-link @if(Request::segment(2)=="institution" || Request::segment(3)== "institution") active @endif">
          ...
          <ul class="nav nav-treeview" style="@if(Request::segment(2)=="institution") display:block; @endif">
            <li class="nav-item">
              <a href="{{ route('admin.institution.category') }}" class="nav-link @if(Request::segment(3)=="institution" || Request::segment(2)=="category") active @endif">
                <ion-icon name="return-down-forward-outline"></ion-icon>
                <p>{{ __('main.Categories') }}</p>
              </a>
            </li>
            <li class="nav-item"> 
              <a href="{{ route('admin.institution.index') }}" class="nav-link @if(Request::segment(2)=="institution" && Request::segment(3)!="create") active @endif">
                  <ion-icon name="return-down-forward-outline"></ion-icon>
                  <p>{{ __('All Institutions') }}</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('admin.institution.create') }}" class="nav-link @if(Request::segment(2)=="institution" && Request::segment(3)=="create") active @endif">
                  <ion-icon name="return-down-forward-outline"></ion-icon>
                  <p>{{ __('Add Institutions') }}</p>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item has-treeview @if(Request::segment(2)=="page") menu-open @endif">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.vocation.index') }}" class="nav-link @if(Request::segment(2)=="vocation") active @endif">
                <i class="fas fa-envelope nav-icon"></i>
              <p>{{ __('Vocation Request') }}</p>
            </a>
          </li>
