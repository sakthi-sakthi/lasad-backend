...
<head>
  ...
  <title>Welcome to De La Salle Brothers | {{ __('main.Login') }}</title>
...
<body class="hold-transition login-page body" >
  <div class="register-logo">
    <img src="{{asset('admin')}}/img/delasalle.png" style="width: 160px;" alt="logo"><br>
    <center><h2 style="color:black
     ; font-weight: 700;
   font-family: serif;"><b style="color: #fee082"> ADMIN LOGIN</b><br>
   <b style="color:white ">WELCOME TO DE LA SALLE BROTHERS</b>
   </h2></center>
  </div>
<div class="login-box">
  <div class="card" >
